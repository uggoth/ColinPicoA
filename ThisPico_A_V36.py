...
import Motor_V05 as Motor
import NeoPixel_v13 as NeoPixel
import SBUSReceiver_V06 as SBUSReceiver
import CommandStreamPico_V07 as CommandStream
import utime
import machine
import _thread
...
class ReversingBuzzer(GPIO.Buzzer):
    def __init__(self):
        super().__init__('Reversing Buzzer',14)
...
class ThisHandshake(GPIO.DigitalOutput):
    def __init__(self):
        super().__init__('Pi Handshake','OUTPUT',22)
